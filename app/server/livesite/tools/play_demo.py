...
def main(unused_argv):
    ...
    while True:
        ...
        def convert_time(timestamp):
            return int((timestamp - first_timestamp) / FLAGS.time_scale +
                       base_time)
        ...
        for (standings_feed, timestamp), (_, next_timestamp) in zip(
                standings_timestamp_feeds, standings_timestamp_feeds[1:]):
